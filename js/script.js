// const heartButtons = document.getElementsByClassName("fa-heart");
// //event for liking the heart button
// Array.from(heartButtons).forEach(function(button) {
//     button.addEventListener("dblclick", function() {
//         button.classList.add("fa-heart-like");
//     });

//     button.addEventListener("click", function(){
//       button.classList.remove("fa-heart-like")
//     })
// });
//HARDER METHOD WITHOUT USING .querySelector()

//EASIER METHOD USING .querySelector() 🧠
